...
public class TestThreads {
  ...
  public void testDeleteThread() throws Exception {
    ...
    driver.findElement(By.xpath("//div[@id='root']/div/div/div/div/form/div[3]/button")).click();
    Thread.sleep(1000);
    driver.findElement(By.xpath("//div[@id='root']/div/div/div/div/div/div/div/div[3]")).click();
    Thread.sleep(1000);
    driver.findElement(By.xpath("//div[@id='rc-tabs-0-panel-3']/ul/div/div/div/div[2]/button/span")).click();
    Thread.sleep(1000);
    driver.findElement(By.xpath("//button[2]/span")).click();
    Thread.sleep(1000);
    driver.findElement(By.id("rc-tabs-0-tab-3")).click();
    Thread.sleep(1500);
    driver.findElement(By.linkText("Log Out")).click();
    Thread.sleep(1000);
  }
  ...
  public void testGetThread() throws Exception {
    ...
    Thread.sleep(1000);
    driver.findElement(By.linkText("Go to Group")).click();
    Thread.sleep(1000);
    driver.findElement(By.linkText("Log Out")).click();
    Thread.sleep(1000);
  }
